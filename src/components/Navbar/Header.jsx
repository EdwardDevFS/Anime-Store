import Button from '../Buttons/ButtonMio';
import { Link } from "react-router-dom"
import './Header.scss';
import Slide from '../Carrito/Slide';
            ...
            <nav className="items-nav me-5">
                <ul className="list-ul">
                    ...
                    <div className="d-flex align-center ms-5 me-2 my-3">
                        <Link to="/login">
                            <ButtonMio Tipo="btn btn-outline-success boton">INGRESAR</ButtonMio>
                        </Link>
                    </div>
                </ul>
            </nav>
                <div className="carrito me-3 d-flex ms-2 me-5">
                    <Slide clase="btn btn-dark m">
                        ...
                        <div><span className='itemsInCart'>{totalItemsInCart}</span></div>
                    </Slide>
