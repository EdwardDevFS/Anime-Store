let figuras= [
    ...
    {
        categoria : "Figuras",
        title:"Saitama de One Punch Man",
        anime: "one_punch_man",
        personaje: "saitama",
        description:" y los revisamos antes de proceder al envío definitivo, si hay algún producto deteriorado lo devolvemos automáticamente a nuestro distribuidor.",
    ...
    },
    {
        ...
        anime: "Kimetsu_no_yaiba",
        personaje: "tanjirou_kamado",
        description:" ¡Tanjirou Kamado, el cazador de demonios que persigue al demonio que asesinó a su familia y convirtió a su hermana Nezuko en un demonio, hace otra aparición en la línea Banpresto con esta figura! Esta vez viene sin su abrigo largo, revelando el uniforme estándar de Demon Hunter.",
        caracter: "6,3 pulgadas (16 cm)\nFabricado en PVC y ABS.\nDe la serie Demon Slayer: Kimetsu no Yaiba\nno articulado\nSe requiere algún ensamblaje\nIncluye peana",
        url:"https://cdn.shopify.com/s/files/1/0729/8793/products/10448934-7056-495e-89c6-c27cc315cd94_180x.jpg?v=1659899036",
    ...
    },
    {
        ...
        title:"Demon Slayer: Kimetsu no Yaiba",
        personaje: "Makomo",
        description:" ¡Del Demon Slayer: Kimetsu no Yaiba anime viene una figura de Makomo! Ella mide casi 6 pulgadas de alto y ha sido recreada fielmente.",
        caracter: "5,9 pulgadas (15 cm)\nHecho de plástico\nDe la serie Demon Slayer: Kimetsu no Yaiba\nversión sepia\nMuy detallado\nno articulado",
        url:"https://cdn.shopify.com/s/files/1/0729/8793/products/b74f59b7-a4c5-41fd-835f-0917d9727ae2_180x.jpg?v=1664552242",
...
let funko= [
    {
        ...
        description:"¡Estallido! las figuras dan vida a tus personajes de anime favoritos (y villanos) con diseños estilizados únicos. ¡Esta figura de vinilo de gran tamaño de Gigantomachia mide 6 pulgadas de alto y viene en una caja con ventana, lo que la hace ideal para exhibirla!",
